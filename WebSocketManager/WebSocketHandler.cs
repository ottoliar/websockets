...
namespace WebSocketManager
{
    ...
    {
        protected IWebSocketConnectionManager _webSocketConnectionManager { get; set; }
        ...
        {
            await _webSocketConnectionManager.RemoveSocket(_webSocketConnectionManager.GetId(socket)).ConfigureAwait(false);
        }
        ...
        {
            await SendMessageAsync(_webSocketConnectionManager.GetSocketById(socketId), message).ConfigureAwait(false);
        }
